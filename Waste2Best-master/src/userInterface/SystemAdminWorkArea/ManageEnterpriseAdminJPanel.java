...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void populateTable() {
        ...
        system.getNetworkList().stream().forEach((network) -> {
            network.getEnterpriseDirectory().getEnterpriseList().stream().forEach((enterprise) -> {
                enterprise.getUserAccountDirectory().getUserAccountList().stream().map((userAccount) -> {
